...
const list = (req: Request, res: Response, next: NextFunction) => {
  Controller.list(Number(req.query.idProd))
    .then((lista: any) => {
      success({
        req,
        res,
...
const ultMov = (req: Request, res: Response, next: NextFunction) => {
  Controller.ultimosMovStock(Number(req.query.idPv), Number(req.query.idProd))
    .then((lista: any) => {
      success({
        req,
        res,
...
const moverStock = (req: Request, res: Response, next: NextFunction) => {
...
const ultStockList = (req: Request, res: Response, next: NextFunction) => {
...
const listaStock = (req: Request, res: Response, next: NextFunction) => {
...
const getStockProd = (req: Request, res: Response, next: NextFunction) => {
  Controller.getStockProd(Number(req.query.idProd), Number(req.query.pvId))
    .then((data) => {
      success({ req, res, message: data });
    })
    .catch(next);
